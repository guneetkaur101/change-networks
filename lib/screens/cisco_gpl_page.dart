// // //all circle created not responsive without inner scroabllbar
// import 'dart:ui';
...
//       decoration: BoxDecoration(
//         color: Colors.black, // White background for the block
...
//       ),
//       child: Row(
//         mainAxisSize: MainAxisSize.min, // Keep content size
//         children: [
//           Container(
...
//                   color: Colors.white, // Dark text for the title
//                   fontSize: 14,
...
//                 subtitle,
//                 style: const TextStyle(
//                   color: Colors.white54, // Grey text for the subtitle
//                   fontSize: 13,
//                 ),
//               ),
//             ],
...
// }
//
// class CiscoPriceListHeader extends StatelessWidget {
...
//     ["1", "NETWORK-PNP-LIC", "1832"],
//     ["2", "C9K-ACC-RBFT", "1289"],
//     ["3", "C9200L-DNA-E-48-3Y", "1265"],
//     ["4", "C9200L-DNA-E-24-3Y", "1043"],
//     ["5", "C9200L-48T-4G-E", "1022"],
//     ["1", "NETWORK-PNP-LIC", "1832"],
//     ["2", "C9K-ACC-RBFT", "1289"],
//     ["3", "C9200L-DNA-E-48-3Y", "1265"],
//     ["4", "C9200L-DNA-E-24-3Y", "1043"],
...
//
//       if (query.isEmpty) {
//         // Show all for "Top Search", nothing for others
//         _filteredData = _activeTab == 'Top Search' ? List.from(_allData) : [];
//       } else {
//         _filteredData = _allData
//             .where((row) => row[1].toLowerCase().startsWith(query))
//             .toList();
//       }
//     });
//   }
...
//             side: BorderSide(color: isActive ? Colors.lightBlue : Colors.grey[400]!),
...
//             setState(() {
//               _activeTab = label;
//               _onSearch(); // trigger search on tab switch
//             });
//           },
//           child: Text(label,
//               style: TextStyle(
//                   color: isActive ? Colors.white : Colors.grey[700], // Adjusted text color
//                   fontWeight: FontWeight.w500)),
//         );
//       }).toList(),
//     );
...
//         dataTextStyle: TextStyle(color: Colors.black54),
//         columns: const [
//           DataColumn(label: Text('Rank')),
//           DataColumn(label: Text('Product Code')),
//           DataColumn(label: Text('Search Frequency')),
//         ],
//         rows: _filteredData
//             .map((row) =>
...
// //all circle created (actual code without api intregration)
// import 'dart:ui';
// import 'package:flutter/material.dart';
// import 'package:glassmorphism/glassmorphism.dart';
//
...
// class _CiscoSearchBarState extends State<CiscoSearchBar> {
//   final TextEditingController _searchController = TextEditingController();
//   late Future<List<TopSearchProduct>> _topSearchFuture;
//   String _activeTab = 'Top Search';
//   String _searchQuery = "";
//
//
...
//     super.initState();
//     _filteredData = List.from(_allData);
//     _topSearchFuture = ApiService.fetchTopSearchProducts();
//     _searchController.addListener(() {
//       setState(() {}); // So the suffixIcon updates live
//     });
//   }
...
//     );
//   }
// //previous non scrollable visble bg
//   // Widget _buildDataTable() {
//   //   if (_filteredData.isEmpty) {
//   //     return Padding(
//   //       padding: const EdgeInsets.all(24),
...
//   // }
//
//   //white bg inner scrollbale not full size
//
//   Widget _buildDataTable() {
//     if (_filteredData.isEmpty) {
//       return Padding(
...
//                   Expanded(flex: 3, child: Text('Product Code', style: TextStyle(fontWeight: FontWeight.bold))),
//                   Expanded(flex: 2, child: Text('Search Frequency', style: TextStyle(fontWeight: FontWeight.bold))),
//                 ],
//               ),
//             ),
//             // Scrollable content
...
//                       child: Row(
//                         children: [
//                           Expanded(flex: 1, child: Text(row[0])),
...
//api intregration testing(cisco effective api  and top search api working)
// import 'dart:ui';
// import 'package:flutter/material.dart';
// import 'package:glassmorphism/glassmorphism.dart';
// import '../models/top_search_model.dart';
...
//       if (query.isEmpty) {
//         // Show all for "Top Search", nothing for others
//         _filteredProducts = _activeTab == 'Top Search' ? List.from(_allProducts) : [];
//       } else {
//         _filteredProducts = _allProducts
//             .where((p) => p.procCode.toLowerCase().startsWith(query))
//             .toList();
//       }
//     });
//   }
...
//                           Expanded(flex: 2, child: Text(product.searchFrequency.toString())),
//                         ],
//                       ),
//                     );
//                   },
...
//api intregration testing(cisco effective api  and top search api working-withclicking on top search product navigate to gpl seach and searching in top search enabled also in gpl search typing keyword results in single result instead of list )
// import 'dart:ui';
// import 'package:flutter/material.dart';
// import 'package:glassmorphism/glassmorphism.dart';
...
//   //     // Filter top products list by procCode
//   //     if (query.isEmpty) {
//   //       setState(() {
...
//   //       setState(() {
//   //         _filteredProducts = _allProducts
//   //             .where((product) => product.procCode.toLowerCase().startsWith(query))
//   //             .toList();
//   //       });
//   //     }
//   //   } else if (_activeTab == 'GPL Search' || _activeTab == 'Product Search') {
//   //     if (query.isNotEmpty) {
//   //       final product = await ProductDetailApi.fetchProductDetail(query);
//   //       if (product != null) {
//   //         setState(() {
//   //           _selectedProduct = product;
//   //         });
...
//     } else if (_activeTab == 'GPL Search' || _activeTab == 'Product Search') {
//       if (query.isNotEmpty) {
//         final filteredResults = await GplPaginatedApi.fetchFilteredProducts(query);
//
//         if (filteredResults.isNotEmpty) {
//           setState(() {
//             _selectedProduct = filteredResults.first; // You can show multiple later
//           });
//         } else {
//           setState(() {
//             _selectedProduct = null;
...
//     );
//   }
//   Widget _buildProductDetailTable() {
...
//               child: const Row(
//                 children: [
//                   Expanded(flex: 2, child: Text('Product Code', style: TextStyle(fontWeight: FontWeight.bold))),
//                   Expanded(flex: 4, child: Text('Description', style: TextStyle(fontWeight: FontWeight.bold))),
//                   Expanded(flex: 2, child: Text('GPL (\$)', style: TextStyle(fontWeight: FontWeight.bold))),
//                   Expanded(flex: 2, child: Text('EOS', style: TextStyle(fontWeight: FontWeight.bold))),
//                   Expanded(flex: 2, child: Text('GET QUOTE', style: TextStyle(fontWeight: FontWeight.bold))),
//                 ],
//               ),
//             ),
//             Container(
...
//               child: Row(
//                 children: [
//                   Expanded(flex: 2, child: Text(_selectedProduct!.procCode)),
//                   Expanded(flex: 4, child: Text(_selectedProduct!.proDesc)),
//                   Expanded(flex: 2, child: Text("\$${_selectedProduct!.price.toStringAsFixed(2)}")),
//                   Expanded(flex: 2, child: Text(  'N/A')),   //_selectedProduct!.eos??
//                   Expanded(
//                     flex: 2,
//                     child: ElevatedButton(
//                       onPressed: () {
//                         // TODO: Add quote logic
//                       },
//                       style: ElevatedButton.styleFrom(
//                         backgroundColor: Colors.black87,
...
//   }
//
//   Widget _buildGplSearchResult() {
//     if (_selectedProduct == null || _activeTab != 'GPL Search') return SizedBox.shrink();
//
//     return Container(
//       margin: const EdgeInsets.only(top: 30),
...
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           Text("Product Code: ${_selectedProduct!.procCode}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
//           SizedBox(height: 8),
//           Text("Description: ${_selectedProduct!.proDesc}", style: TextStyle(fontSize: 14)),
//           SizedBox(height: 8),
//           Text("GPL Price: \$${_selectedProduct!.price.toStringAsFixed(2)}", style: TextStyle(fontSize: 14, color: Colors.green[700])),
//         ],
//       ),
//     );
//   }
...
//           if (_activeTab == 'GPL Search') _buildProductDetailTable(),
//           if (_activeTab == 'Product Search') _buildProductDetailTable(),
//
//         ],
//       ),
//
