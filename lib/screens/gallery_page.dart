...
class _GalleryPageState extends State<GalleryPage> with TickerProviderStateMixin {
  ...
  late final _switches = _SectionController(
    label: 'Switches',
    loader: () => _api.getSwitches(limits: 12, page: 1, search: _switchSearchTerm),
  );
  ...
  Future<void> _bootstrap() async {
    try {
      ...
      // Preload remaining sections; if 404, they render as empty (no error)
  ...
  Future<void> _performSearch(String? term) async {
    ...
    setState(() => _switches.loading = true); // show skeleton immediately
  ...
  void _openFull(String title) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (_) => FullCategoryGrid(
        ...
        loader: () {
          switch (title) {
            case 'Switches': return _api.getSwitches(limits: 24, page: 1, search: _switchSearchTerm);
        ...
        loadMore: (page) {
          switch (title) {
            case 'Switches': return _api.getSwitches(limits: 24, page: page, search: _switchSearchTerm);
        ...
        children: [
          ...
          AnimatedSwitcher(
            ...
            child: Builder(builder: (context) {
              ...
              if (controller.items.isEmpty) return const _InlineEmpty();        // no error spill
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(item.productCode, maxLines: 1, overflow: TextOverflow.ellipsis, style: t.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600)),
                  ),
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, c) {
      ...
      return GridView.builder(
        ...
        itemCount: cols * 2,
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: cols, mainAxisSpacing: 14, crossAxisSpacing: 14, childAspectRatio: 4 / 3,
        ),
