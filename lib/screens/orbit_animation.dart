//icons moving in semi arc but not spacing
...
//
//   final List<IconData> clockwiseIcons = [
//     Icons.code, Icons.analytics, Icons.security,
//     Icons.devices, Icons.lightbulb, Icons.bug_report,
//     Icons.data_usage, Icons.smartphone, Icons.auto_graph,
//   ];
//
//   final List<IconData> anticlockwiseIcons = [
//     Icons.cloud, Icons.storage, Icons.wifi,
//     Icons.computer, Icons.router, Icons.hub,
//     Icons.api, Icons.bar_chart, Icons.memory,
//   ];
//
//
//   @override
...
//               ),
//
//               // Outer orbit - clockwise with visibility check
//               for (int i = 0; i < clockwiseIcons.length; i++)
//                 Builder(builder: (context) {
//                   final double angle = pi * i / clockwiseIcons.length + _controller.value * 2 * pi;
//                   final Offset pos = _calculatePosition(outerOrbitRadius, angle);
//
//                   // Keep only top half visible
//                   if (sin(angle) > 0) return const SizedBox.shrink();
//
//                   return Transform.translate(
//                     offset: pos,
//                     child: _orbitIcon(clockwiseIcons[i]),
//                   );
//                 }
//                 ),
//
//
//
//               // Inner orbit - anticlockwise with visibility check
//               for (int i = 0; i < anticlockwiseIcons.length; i++)
//                 Builder(builder: (context) {
//                   final double angle = 2 * pi * i / anticlockwiseIcons.length - _controller.value * 2 * pi;
//                   final Offset pos = _calculatePosition(innerOrbitRadius, angle);
//
//                   if (sin(angle) > 0) return const SizedBox.shrink();
//
//                   return Transform.translate(
//                     offset: pos,
//                     child: _orbitIcon(anticlockwiseIcons[i]),
//                   );
//                 }),
//                  ],
//           ),
...
//
//     // Draw top half arcs (start at 180°, sweep 180° counter-clockwise)
//     canvas.drawArc(innerRect, pi, pi, false, orbitPaint); // Inner orbit semi-circle
//     canvas.drawArc(outerRect, pi, pi, false, orbitPaint); // Outer orbit semi-circle
//   }
//
//   @override
